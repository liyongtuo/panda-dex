...
DarkTheme.prototype.__construct = function () {
    this._colors = [];
    this._colors[Theme.Color.Positive] = "#00ba53";//跌价 绿色
    this._colors[Theme.Color.Negative] = "#FF3232";//涨价 红色
...
LightTheme.prototype.__construct = function () {
    this._colors = [];
    this._colors[Theme.Color.Positive] = "#53b37b";//绿色，跌价
    this._colors[Theme.Color.Negative] = "#db5542";//红色，涨价
...
var RequestData = function (showLoading) {
    ...
    if (size > 0) {
        ...
        console.log("即時數據");
        console.log(JSON.stringify(jishi.datas.data));
    }
...
function readCookie() {
    ...
    chart_switch_language(localStorage.getItem("lang") || "zh-CN")
}
var main = function () {
...
function switch_period(a) {
    if (window.periodChange) {
        window.periodChange(a)
    }
